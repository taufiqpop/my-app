...
class MenusController extends Controller
{
    ...
    {
        $list = Menu::select(DB::raw('id, parent_id, name, slug_name, icon, link, grup_menu, created_at'))->with('parent');
        ...
        try {
            ...
            switch ($menu_type) {
                case 'main':
                    ...
                    $menu->grup_menu = $request->grup_menu;
