    ...
    table = $('#table-data').DataTable({
        ...
        columns: [{
            ...
            render: (data, type, row) => {
                const imagePath = data ? `storage/${data}` : '/img/user_icon.png';
                return `<img src="${imagePath}" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">`;
            }
        }, {
            data: 'name',
        }, {
