...
@section('contents')
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="custom-control custom-radio mb-3">
                                        <input type="radio" id="type-main" name="menu_type" class="custom-control-input" value="main">
                                        <label class="custom-control-label" for="type-main">Menu Utama</label>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="custom-control custom-radio mb-3">
                                        <input type="radio" id="type-child" name="menu_type" class="custom-control-input" value="child">
                        ...
                        <div class="div-menu-type div-main">
                                ...
                                <table class="table table-striped table-bordered table-icons" style="width: 100%">
                                    ...
                                    <tbody>
                                        @foreach (icons() as $key => $value)
                                            <tr>
                                                <td class="text-center" style="width: 30%;"><i class="{{ $value }} fa-2x text-primary pilih-icon" data-icon_name="{{ $value }}"></i></td>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="icon" id="icon" class="form-control" placeholder="Pilih Ikon Menu di Tabel Di Atas" readonly>
    ...
    {{-- Update --}}
    <div id="modal-update-menu" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-update-menuLabel" aria-hidden="true">
        <form action="{{ route('manajemen-menu.update') }}" method="post" id="form-update-menu" autocomplete="off">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="update-grup_menu">Nama Menu</label>
                            <select name="grup_menu" id="update-grup_menu" class="form-control">
                                <option value="" selected disabled>Pilih Grup Menu</option>
                                <option value="Administrator">Administrator</option>
                                <option value="Data">Data</option>
                            </select>
                            <div id="error-update-grup_menu"></div>
                        </div>
                        <div class="form-group">
                            <label for="update-name">Nama Menu</label>
                            <input type="text" name="name" id="update-name" class="form-control" placeholder="Masukkan Nama Menu" required>
                            <div id="error-update-name"></div>
                        </div>
                        <div class="form-group">
                            <label for="update-link">Tautan Menu</label>
                            <input type="text" name="link" id="update-link" class="form-control" placeholder="Masukkan Tautan">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="custom-control custom-radio mb-3">
                                        <input type="radio" id="type-update-main" name="menu_type" class="custom-control-input" value="main">
                                        <label class="custom-control-label" for="type-update-main">Menu Utama</label>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="custom-control custom-radio mb-3">
                                        <input type="radio" id="type-update-child" name="menu_type" class="custom-control-input" value="child">
                        ...
                        <div class="div-menu-type div-main">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="icon" id="update-icon" class="form-control" placeholder="Pilih Ikon Menu di Tabel Di Atas" readonly>
...
@push('scripts')
    <script src="{{ asset('js/page/administrator/menu/list.js?q=' . Str::random(5)) }}"></script>
@endpush
