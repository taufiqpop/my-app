            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="bg-soft-primary">
                            <div class="row">
                                ...
                                <div class="col-5 align-self-end">
                                    <img src="{{ config('app.theme') }}assets/images/Personal.png" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <div>
                                <a href="{{ route('personal') }}" target="_blank">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                                            <img src="{{ config('app.theme') }}assets/images/logo/Personal_Header.png" alt="" class="rounded-circle" height="75">
                                        </span>
                                    </div>
                                </a>
                            </div>
                            <div class="p-2">
                                <form class="form-horizontal" action="{{ route('choose-role') }}" method="post" id="form-choose-role">
                                    @csrf
                                    <input type="hidden" name="user_id" value="{{ Crypt::encrypt($user->id) }}">
                                    <div class="user-thumb text-center mb-4">
                                        <img src="{{ Auth::user()->path ? asset('storage/' . Auth::user()->path) : asset('img/user_icon.png') }}" class="rounded-circle img-fluid avatar-xl">
                                    ...
                                    @else
                                        <div class="alert alert-danger" role="alert">
                                            Anda belum memiliki hak akses untuk masuk ke dalam sistem. Hubungi admin
                    ...
                    <div class="mt-5 text-center">
                        <div>
                            <p>Bukan Anda? <a href="{{ route('logout') }}" class="font-weight-medium text-primary" onclick="event.preventDefault();
