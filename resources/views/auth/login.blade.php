                                        ...
                                        <form class="form-horizontal" action="{{ route('login') }}" autocomplete="off" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" value="{{ old('password') }}" placeholder="Masukkan Kata Sandi">
                                            ...
                                            {{-- Button Register --}}
                                            <div class="mt-2">
                                                <button type="button" class="btn btn-dark btn-block waves-effect waves-light" type="submit" style="cursor: default" disabled>Register</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
